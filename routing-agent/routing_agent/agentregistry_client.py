...
class AgentRegistryClient:
    ...
    def __init__(
        self, 
        base_url: str = "http://orchestrator-registry.dac.svc.cluster.local:10100",
        timeout: int = 300
    ):
        """
        Initialize client
        ...
        """
        AgentRegistry = os.getenv("AgentRegistry", "http://orchestrator-registry.dac.svc.cluster.local:10100")
