...
# 6. Get All Groups members

curl -X GET "http://192.168.3.7:22000/semantic_groups/e4769924-0728-4901-bf17-a41355886b44/with_members" \
-H "Content-Type: application/json" \
-d '{}' | jq .
...
# 12. Batch Create DD Group Relations
...
# 16. Delete Relations by Group ID
...
curl -X POST http://192.168.3.238:22000/semantic_groups/maintenance/purge_orphan_vectors \
  -H "Content-Type: application/json" \
  -d '["38add88c-be2e-4de1-8e2f-db2a0892b38d", "d63d23eb-25d0-45e8-bf0c-44c925008721", "83c4badd-dbfa-4512-b598-ab76c1508cb3"]'
