...
# Semantic Domain API 手测（请求/响应字段与 data_services/api/base.py 中
# SemanticDomain、SemanticDomainCreateRequest、SemanticDomainUpdateRequest 一致，含 descriptor_type、version）
