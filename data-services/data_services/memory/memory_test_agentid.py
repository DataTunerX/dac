...
class MemoryServiceTester:
    ...
    def test_add_memory(self):
        ...
        if 'results' in result and len(result['results']) > 0:
            ...
            all_memories = memory_service.get_all_memories(agent_id=self.test_agent_id)
            if all_memories:
    ...
    def test_get_all_memories(self):
        ...
        logger.info(f"=====Testing get_all_memories for agent: {self.test_agent_id}")
        
        result = memory_service.get_all_memories(agent_id=self.test_agent_id)
        logger.info(f"Found {len(result)} memories for agent {self.test_agent_id}")
    ...
    def test_delete_all_memories(self):
        """Test deleting all memories for agent"""
        logger.info(f"=====Testing delete_all_memories for agent: {self.test_agent_id}")
        
        result = memory_service.delete_all_memories(agent_id=self.test_agent_id)
