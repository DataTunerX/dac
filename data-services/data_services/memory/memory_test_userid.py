...
class MemoryServiceTester:
    ...
    def test_add_memory(self):
        ...
        if 'results' in result and len(result['results']) > 0:
            ...
            all_memories = memory_service.get_all_memories(user_id=self.test_user_id)
            if all_memories:
    ...
    def test_get_all_memories(self):
        ...
        result = memory_service.get_all_memories(user_id=self.test_user_id)
    ...
    def test_delete_all_memories(self):
        ...
        result = memory_service.delete_all_memories(user_id=self.test_user_id)
