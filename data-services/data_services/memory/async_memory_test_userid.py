...
from memory import async_memory_service
...
class AsyncMemoryServiceTester:
    ...
    async def setup(self):
        ...
        # Initialize memory service - need to wait for async initialization
    ...
    async def test_add_memory(self):
        ...
        if 'results' in result and len(result['results']) > 0:
            ...
            all_memories = await async_memory_service.get_all_memories(user_id=self.test_user_id)
            if all_memories:
    ...
    async def test_get_memory(self):
        ...
        result = await async_memory_service.get_memory(self.test_memory_id)
    ...
    async def test_get_all_memories(self):
        ...
        result = await async_memory_service.get_all_memories(user_id=self.test_user_id)
    ...
    async def test_search_memories(self):
        ...
        result = await async_memory_service.search_memories(
            query="sci-fi movies",
            user_id=self.test_user_id,
            limit=3
        )
    ...
    async def test_get_memory_history(self):
        ...
        result = await async_memory_service.get_memory_history(self.test_memory_id)
    ...
    async def test_delete_memory(self):
        ...
        result = await async_memory_service.delete_memory(self.test_memory_id)
    ...
    async def test_delete_all_memories(self):
        ...
        result = await async_memory_service.delete_all_memories(user_id=self.test_user_id)
    ...
    async def run_basic_test(self):
        ...
        try:
            ...
            if self.test_memory_id:
                try:
                    await async_memory_service.delete_memory(self.test_memory_id)
