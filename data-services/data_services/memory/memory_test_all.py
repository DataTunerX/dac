...
class MemoryServiceTester:
    ...
    def test_add_memory(self):
        ...
        if 'results' in result and len(result['results']) > 0:
            ...
            all_memories = memory_service.get_all_memories(user_id=self.test_user_id, agent_id=self.test_agent_id, run_id=self.test_run_id)
            if all_memories:
    ...
    def test_get_all_memories(self):
        ...
        logger.info(f"=====Testing get_all_memories for user: {self.test_user_id}, agent: {self.test_agent_id}, run: {self.test_run_id}")
        
        result = memory_service.get_all_memories(user_id=self.test_user_id, agent_id=self.test_agent_id, run_id=self.test_run_id)
        logger.info(f"Found {len(result)} memories for user {self.test_user_id}, agent: {self.test_agent_id}, run: {self.test_run_id}")
    ...
    def test_delete_all_memories(self):
        ...
        logger.info(f"=====Testing delete_all_memories for user: {self.test_user_id}, agent: {self.test_agent_id}, run: {self.test_run_id}")
        
        result = memory_service.delete_all_memories(user_id=self.test_user_id, agent_id=self.test_agent_id, run_id=self.test_run_id)
