...
When ``SKILL_DOWNLOAD_OVERWRITE`` is truthy, a downloaded zip replaces any
existing file of the same name under ``SKILLS_DOWNLOAD_DIR`` (including
image-baked packs under ``/app/skills/``).
...
SKILLS
    List of skills to download. Accepts:
      ...
      - Object array (SG skillPolicy / skill DAC):
