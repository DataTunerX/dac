...
CAPABILITY_EVALUATION_SCORING_DESIGN.md); cross-domain cases whose expectation
relied on "primary domain match => can_handle" may need to be revisited. See
tests/test_capability_chain_live.py for cases written against the rubric.
