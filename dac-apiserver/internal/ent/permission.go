...
type Permission struct {
	...
	// 权限点编码，全局唯一，如 agent:create
	Code string `json:"code,omitempty"`
	// 权限点展示名
	Name string `json:"name,omitempty"`
	// 资源域，如 agent / descriptor / configmap
	Resource string `json:"resource,omitempty"`
	// 动作，如 read / write / manage
	Action string `json:"action,omitempty"`
	// 允许的HTTP方法；"*"任意，逗号分隔多方法
...
func (*Permission) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case permission.FieldCode, permission.FieldName, permission.FieldResource, permission.FieldAction, permission.FieldHTTPMethod, permission.FieldHTTPPath, permission.FieldDescription:
...
func (_m *Permission) String() string {
	...
	builder.WriteString(_m.HTTPPath)
	builder.WriteString(", ")
