...
func (_u *RunUpdate) SetUserID(v uuid.UUID) *RunUpdate {
	_u.mutation.SetUserID(v)
	return _u
}

// SetNillableUserID sets the "user_id" field if the given value is not nil.
func (_u *RunUpdate) SetNillableUserID(v *uuid.UUID) *RunUpdate {
	if v != nil {
		_u.SetUserID(*v)
	}
	return _u
...
func (_u *RunUpdate) ClearAgentID() *RunUpdate {
...
func (_u *RunUpdate) SetUser(v *User) *RunUpdate {
...
func (_u *RunUpdate) ClearUser() *RunUpdate {
...
func (_u *RunUpdate) check() error {
	if _u.mutation.UserCleared() && len(_u.mutation.UserIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Run.user"`)
	}
	return nil
}
...
func (_u *RunUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.AgentIDCleared() {
		_spec.ClearField(run.FieldAgentID, field.TypeString)
	}
...
// SetUserID sets the "user_id" field.
func (_u *RunUpdateOne) SetUserID(v uuid.UUID) *RunUpdateOne {
	_u.mutation.SetUserID(v)
	return _u
}

// SetNillableUserID sets the "user_id" field if the given value is not nil.
func (_u *RunUpdateOne) SetNillableUserID(v *uuid.UUID) *RunUpdateOne {
	if v != nil {
		_u.SetUserID(*v)
	}
	return _u
...
// ClearAgentID clears the value of the "agent_id" field.
func (_u *RunUpdateOne) ClearAgentID() *RunUpdateOne {
	_u.mutation.ClearAgentID()
	return _u
}
...
// SetUser sets the "user" edge to the User entity.
func (_u *RunUpdateOne) SetUser(v *User) *RunUpdateOne {
	return _u.SetUserID(v.ID)
}
...
// ClearUser clears the "user" edge to the User entity.
func (_u *RunUpdateOne) ClearUser() *RunUpdateOne {
	_u.mutation.ClearUser()
	return _u
}
