...
func (_c *PermissionCreate) SetHTTPPath(v string) *PermissionCreate {
	_c.mutation.SetHTTPPath(v)
	return _c
}
...
func (_c *PermissionCreate) defaults() {
	if _, ok := _c.mutation.HTTPMethod(); !ok {
		v := permission.DefaultHTTPMethod
		_c.mutation.SetHTTPMethod(v)
	}
...
func (_c *PermissionCreate) check() error {
	...
	if _, ok := _c.mutation.HTTPPath(); !ok {
		return &ValidationError{Name: "http_path", err: errors.New(`ent: missing required field "Permission.http_path"`)}
	}
	if v, ok := _c.mutation.HTTPPath(); ok {
...
func (_c *PermissionCreate) createSpec() (*Permission, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.HTTPPath(); ok {
