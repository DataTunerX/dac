...
func (_c *RunCreate) SetUserID(v uuid.UUID) *RunCreate {
...
func (_c *RunCreate) SetID(v uuid.UUID) *RunCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *RunCreate) SetNillableID(v *uuid.UUID) *RunCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *RunCreate) SetUser(v *User) *RunCreate {
...
func (_c *RunCreate) check() error {
	...
	if len(_c.mutation.UserIDs()) == 0 {
		return &ValidationError{Name: "user", err: errors.New(`ent: missing required edge "Run.user"`)}
	}
	return nil
}
