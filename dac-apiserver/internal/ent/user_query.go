...
func (_q *UserQuery) QueryRuns() *RunQuery {
...
func (_q *UserQuery) WithRuns(opts ...func(*RunQuery)) *UserQuery {
	query := (&RunClient{config: _q.config}).Query()
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withRuns; query != nil {
		if err := _q.loadRuns(ctx, query, nodes,
			func(n *User) { n.Edges.Runs = []*Run{} },
			func(n *User, e *Run) { n.Edges.Runs = append(n.Edges.Runs, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadRuns(ctx context.Context, query *RunQuery, nodes []*User, init func(*User), assign func(*User, *Run)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(run.FieldUserID)
	}
	query.Where(predicate.Run(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.RunsColumn), fks...))
	}))
