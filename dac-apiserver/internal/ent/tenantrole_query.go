...
type TenantRoleQuery struct {
	...
	withPermissions *TenantRolePermissionQuery
	withUsers       *TenantUserQuery
...
func (_q *TenantRoleQuery) QueryPermissions() *TenantRolePermissionQuery {
	query := (&TenantRolePermissionClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *TenantRoleQuery) QueryUsers() *TenantUserQuery {
...
func (_q *TenantRoleQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *TenantRoleQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *TenantRoleQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *TenantRoleQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *TenantRoleQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *TenantRoleQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *TenantRoleQuery) WithPermissions(opts ...func(*TenantRolePermissionQuery)) *TenantRoleQuery {
	query := (&TenantRolePermissionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TenantRoleQuery) WithUsers(opts ...func(*TenantUserQuery)) *TenantRoleQuery {
	query := (&TenantUserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(tenantrole.FieldTenantID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.TenantRole.Query().
//		Select(tenantrole.FieldTenantID).
//		Scan(ctx, &v)
...
func (_q *TenantRoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*TenantRole, error) {
	...
	if query := _q.withPermissions; query != nil {
		if err := _q.loadPermissions(ctx, query, nodes,
			func(n *TenantRole) { n.Edges.Permissions = []*TenantRolePermission{} },
			func(n *TenantRole, e *TenantRolePermission) { n.Edges.Permissions = append(n.Edges.Permissions, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withUsers; query != nil {
		if err := _q.loadUsers(ctx, query, nodes,
			func(n *TenantRole) { n.Edges.Users = []*TenantUser{} },
			func(n *TenantRole, e *TenantUser) { n.Edges.Users = append(n.Edges.Users, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *TenantRoleQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*TenantRole, init func(*TenantRole), assign func(*TenantRole, *Tenant)) error {
	...
	nodeids := make(map[uuid.UUID][]*TenantRole)
	for i := range nodes {
		fk := nodes[i].TenantID
...
func (_q *TenantRoleQuery) loadPermissions(ctx context.Context, query *TenantRolePermissionQuery, nodes []*TenantRole, init func(*TenantRole), assign func(*TenantRole, *TenantRolePermission)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(tenantrolepermission.FieldRoleID)
	}
	query.Where(predicate.TenantRolePermission(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tenantrole.PermissionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *TenantRoleQuery) loadUsers(ctx context.Context, query *TenantUserQuery, nodes []*TenantRole, init func(*TenantRole), assign func(*TenantRole, *TenantUser)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*TenantRole)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(tenantuser.FieldRoleID)
	}
	query.Where(predicate.TenantUser(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tenantrole.UsersColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *TenantRoleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(tenantrole.Table, tenantrole.Columns, sqlgraph.NewFieldSpec(tenantrole.FieldID, field.TypeUUID))
	_spec.From = _q.sql
