...
func HTTPPath(v string) predicate.Permission {
	return predicate.Permission(sql.FieldEQ(FieldHTTPPath, v))
}
...
func HTTPPathEQ(v string) predicate.Permission {
	return predicate.Permission(sql.FieldEQ(FieldHTTPPath, v))
}

// HTTPPathNEQ applies the NEQ predicate on the "http_path" field.
func HTTPPathNEQ(v string) predicate.Permission {
	return predicate.Permission(sql.FieldNEQ(FieldHTTPPath, v))
}

// HTTPPathIn applies the In predicate on the "http_path" field.
func HTTPPathIn(vs ...string) predicate.Permission {
	return predicate.Permission(sql.FieldIn(FieldHTTPPath, vs...))
}

// HTTPPathNotIn applies the NotIn predicate on the "http_path" field.
func HTTPPathNotIn(vs ...string) predicate.Permission {
	return predicate.Permission(sql.FieldNotIn(FieldHTTPPath, vs...))
}

// HTTPPathGT applies the GT predicate on the "http_path" field.
func HTTPPathGT(v string) predicate.Permission {
	return predicate.Permission(sql.FieldGT(FieldHTTPPath, v))
}

// HTTPPathGTE applies the GTE predicate on the "http_path" field.
func HTTPPathGTE(v string) predicate.Permission {
	return predicate.Permission(sql.FieldGTE(FieldHTTPPath, v))
}

// HTTPPathLT applies the LT predicate on the "http_path" field.
func HTTPPathLT(v string) predicate.Permission {
	return predicate.Permission(sql.FieldLT(FieldHTTPPath, v))
}

// HTTPPathLTE applies the LTE predicate on the "http_path" field.
func HTTPPathLTE(v string) predicate.Permission {
	return predicate.Permission(sql.FieldLTE(FieldHTTPPath, v))
}

// HTTPPathContains applies the Contains predicate on the "http_path" field.
func HTTPPathContains(v string) predicate.Permission {
	return predicate.Permission(sql.FieldContains(FieldHTTPPath, v))
}

// HTTPPathHasPrefix applies the HasPrefix predicate on the "http_path" field.
func HTTPPathHasPrefix(v string) predicate.Permission {
	return predicate.Permission(sql.FieldHasPrefix(FieldHTTPPath, v))
}

// HTTPPathHasSuffix applies the HasSuffix predicate on the "http_path" field.
func HTTPPathHasSuffix(v string) predicate.Permission {
	return predicate.Permission(sql.FieldHasSuffix(FieldHTTPPath, v))
}

// HTTPPathEqualFold applies the EqualFold predicate on the "http_path" field.
func HTTPPathEqualFold(v string) predicate.Permission {
	return predicate.Permission(sql.FieldEqualFold(FieldHTTPPath, v))
}

// HTTPPathContainsFold applies the ContainsFold predicate on the "http_path" field.
func HTTPPathContainsFold(v string) predicate.Permission {
	return predicate.Permission(sql.FieldContainsFold(FieldHTTPPath, v))
}
