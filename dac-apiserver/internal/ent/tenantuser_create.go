...
func (_c *TenantUserCreate) SetRoleID(v uuid.UUID) *TenantUserCreate {
...
func (_c *TenantUserCreate) SetRole(v *TenantRole) *TenantUserCreate {
...
func (_c *TenantUserCreate) check() error {
	...
	if len(_c.mutation.RoleIDs()) == 0 {
		return &ValidationError{Name: "role", err: errors.New(`ent: missing required edge "TenantUser.role"`)}
	}
	return nil
}
