...
func (_u *PermissionUpdate) SetHTTPPath(v string) *PermissionUpdate {
	_u.mutation.SetHTTPPath(v)
	return _u
}

// SetNillableHTTPPath sets the "http_path" field if the given value is not nil.
func (_u *PermissionUpdate) SetNillableHTTPPath(v *string) *PermissionUpdate {
	if v != nil {
		_u.SetHTTPPath(*v)
	}
	return _u
...
func (_u *PermissionUpdate) check() error {
	...
	if v, ok := _u.mutation.HTTPPath(); ok {
		if err := permission.HTTPPathValidator(v); err != nil {
			return &ValidationError{Name: "http_path", err: fmt.Errorf(`ent: validator failed for field "Permission.http_path": %w`, err)}
		}
	}
	return nil
}
...
func (_u *PermissionUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.HTTPPath(); ok {
		_spec.SetField(permission.FieldHTTPPath, field.TypeString, value)
	}
...
// SetHTTPPath sets the "http_path" field.
func (_u *PermissionUpdateOne) SetHTTPPath(v string) *PermissionUpdateOne {
	_u.mutation.SetHTTPPath(v)
	return _u
}

// SetNillableHTTPPath sets the "http_path" field if the given value is not nil.
func (_u *PermissionUpdateOne) SetNillableHTTPPath(v *string) *PermissionUpdateOne {
	if v != nil {
		_u.SetHTTPPath(*v)
	}
	return _u
