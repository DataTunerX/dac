...
func (_q *DiscoveryJobQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *DiscoveryJobQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *DiscoveryJobQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *DiscoveryJobQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *DiscoveryJobQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *DiscoveryJobQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(discoveryjob.FieldName).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (_q *DiscoveryJobQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(discoveryjob.Table, discoveryjob.Columns, sqlgraph.NewFieldSpec(discoveryjob.FieldID, field.TypeUUID))
	_spec.From = _q.sql
