...
func (e UserEdges) RunsOrErr() ([]*Run, error) {
	if e.loadedTypes[0] {
		return e.Runs, nil
	}
...
// QueryRuns queries the "runs" edge of the User entity.
func (_m *User) QueryRuns() *RunQuery {
	return NewUserClient(_m.config).QueryRuns(_m)
}
