...
curl -X POST "http://192.168.3.238:26000/codebase_indexers" \
-H "Content-Type: application/json" \
-H "Data-Descriptor: dac_dd202601281443" \
-d '{
...
curl -X POST "http://192.168.3.238:26000/codebase_indexers/batch" \
-H "Content-Type: application/json" \
-H "Data-Descriptor: dac_dd202601281443" \
-d '[
    {
...
curl -X GET "http://192.168.3.238:26000/codebase_indexers/status/count" \
-H "Data-Descriptor: dac_dd202601281443" | jq .
...
curl -X POST "http://192.168.3.238:26000/codebase_indexers/search/by-dd" \
-H "Content-Type: application/json" \
-H "Data-Descriptor: dac_dd202601281443" \
-d '{
    "dd_namespace": "test_namespace",
...
curl -X POST "http://192.168.3.238:26000/codebase_indexers/search/by-filepath" \
-H "Content-Type: application/json" \
-H "Data-Descriptor: dac_dd202601281443" \
-d '{
    "filepath": "/src/main/app.py"
...
# curl -X GET "http://192.168.3.238:26000/codebase_indexers/<CODEBASE_INDEXER_ID>" \
# -H "Data-Descriptor: dac_dd202601281443" | jq .
...
# Replace <CODEBASE_INDEXER_ID> with actual ID
# curl -X PUT "http://192.168.3.238:26000/codebase_indexers/<CODEBASE_INDEXER_ID>" \
# -H "Content-Type: application/json" \
# -H "Data-Descriptor: dac_dd202601281443" \
# -d '{
...
# Replace <CODEBASE_INDEXER_ID> with actual ID
# curl -X GET "http://192.168.3.238:26000/codebase_indexers/<CODEBASE_INDEXER_ID>/exists" \
# -H "Data-Descriptor: dac_dd202601281443" | jq .
...
curl -X GET "http://192.168.3.238:26000/codebase_indexers/dd_info/test_namespace/test_app/exists" \
-H "Data-Descriptor: dac_dd202601281443" | jq .
...
# Replace <CODEBASE_INDEXER_ID> with actual ID
# curl -X DELETE "http://192.168.3.238:26000/codebase_indexers/<CODEBASE_INDEXER_ID>" \
# -H "Data-Descriptor: dac_dd202601281443" | jq .
...
curl -X DELETE "http://192.168.3.238:26000/codebase_indexers/dd_info/test_namespace/test_app" \
-H "Data-Descriptor: dac_dd202601281443" | jq .
