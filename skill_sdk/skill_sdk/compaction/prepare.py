...
from skill_sdk.compaction.cut_point import find_cut_point
from skill_sdk.compaction.file_ops import (
    details_from_file_ops,
    extract_file_ops_from_messages,
    format_file_operations,
)
from skill_sdk.compaction.messages import is_compaction_summary_message, make_compaction_summary_message
from skill_sdk.compaction.prompts import (
    SUMMARIZATION_PROMPT,
    SUMMARIZATION_SYSTEM_PROMPT,
    TURN_PREFIX_SUMMARIZATION_PROMPT,
    UPDATE_SUMMARIZATION_PROMPT,
)
from skill_sdk.compaction.serialize import serialize_conversation
...
class CompactionBoundary:
    ...
    Attributes:
        summary: Structured summary text (including file tags).
        tokens_before: Estimated tokens before compaction.
        details: File-tracking details (readFiles / modifiedFiles).
...
async def compact(
    ...
    *,
    ...
    file_ops = extract_file_ops_from_messages(
        preparation.messages_to_summarize + preparation.turn_prefix_messages,
        preparation.previous_details,
    )
    ...
    details = details_from_file_ops(file_ops)
    summary = summary + format_file_operations(details["readFiles"], details["modifiedFiles"])
