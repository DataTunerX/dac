...
def test_csv_processor_with_local_file():
    print("Starting CsvProcessor test...")
    
    # Initialize processor
    processor = CsvProcessor()
    print("✓ CsvProcessor initialized successfully")
    
    file_path = "/app/testdata/naive.csv"
...
if __name__ == "__main__":
    test_csv_processor_with_local_file()


# python -m data_sinkers.file_processors.csv_test
