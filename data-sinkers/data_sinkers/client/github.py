...
class GitHubClient:
    ...
    def download_repository(self, owner: str, repo: str, target_dir: str, 
        ...
        try:
            ...
            print(f"Zip download failed: {e}, trying git clone method...")
        ...
        try:
            ...
            with zipfile.ZipFile(io.BytesIO(response.content)) as zip_file:
                ...
                if len(extracted_dirs) == 1 and extracted_dirs[0].is_dir():
                    ...
                    print(f"Repository successfully downloaded to: {target_path}")
                    return str(target_path)
                else:
            ...
            print(f"Unexpected error during zip download: {e}")
    ...
    def _download_via_git(self, owner: str, repo: str, branch: str, target_path: Path) -> str:
        ...
        print(f"Downloading repository via git clone from {repo_url}...")
        ...
        try:
            ...
            print(f"Git clone successful: {target_path}")
            return str(target_path)
    ...
    def _download_zip_from_url(self, zip_url: str, target_path: Path) -> str:
        ...
        print(f"Files downloaded to: {target_path}")
        return str(target_path)
